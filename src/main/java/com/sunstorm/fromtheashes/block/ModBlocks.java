package com.sunstorm.fromtheashes.block;
...
public class ModBlocks {
    public static final DeferredRegister.Blocks BLOCKS =
            DeferredRegister.createBlocks(FromTheAshes.MOD_ID);

    public static final DeferredBlock<Block> RAW_MOONSILVER_BLOCK = registerBlock("raw_moonsilver_block",
    ...
    public static final DeferredBlock<Block> MOONSILVER_BLOCK = registerBlock("moonsilver_block",
            () -> new Block(BlockBehaviour.Properties.of()
                    .strength(4f).requiresCorrectToolForDrops().sound(SoundType.COPPER)));

    public static final DeferredBlock<Block> CHTHONIC_GOLD_BLOCK = registerBlock("chthonic_gold_block",
            () -> new Block(BlockBehaviour.Properties.of()
